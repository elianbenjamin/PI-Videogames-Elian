import { FILTER, ORDER, RESET, ALL_GAMES, DETAIL_GAMES,CREATE_GAMES, VIDEOGAMES_NAME } from "./action-types";
...
export const getVideogamesName = (name) => {
  return async (dispatch) => {
      return await axios.get(`http://localhost:3001/videogames/name?name=${name}`)
        .then(response => {
          dispatch({
